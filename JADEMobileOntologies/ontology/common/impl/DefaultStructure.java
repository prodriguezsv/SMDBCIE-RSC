...
public class DefaultStructure implements Structure, Introspectable {
  ...
  public void externalise(AbsObject absObj, Ontology onto) throws OntologyException {
    try {
      ...
      abs.set(CommonTerminologyOntology.STRUCTURE_DEFINITION, (AbsTerm) onto.fromObject(getDefinition()));
      abs.set(CommonTerminologyOntology.STRUCTURE_TERM, (AbsTerm) onto.fromObject(getTerm()));
      abs.set(CommonTerminologyOntology.STRUCTURE_OWNS, (AbsTerm) onto.fromObject(getOwns()));
  ...
  public void internalise(AbsObject absObj, Ontology onto) throws UngroundedException, OntologyException {
    try {
      AbsConcept abs = (AbsConcept) absObj;
      definition = (String)onto.toObject(abs.getAbsObject(CommonTerminologyOntology.STRUCTURE_DEFINITION));
      term = (String)onto.toObject(abs.getAbsObject(CommonTerminologyOntology.STRUCTURE_TERM));
      owns = (List)onto.toObject(abs.getAbsObject(CommonTerminologyOntology.STRUCTURE_OWNS));
     } catch (ClassCastException cce) {
