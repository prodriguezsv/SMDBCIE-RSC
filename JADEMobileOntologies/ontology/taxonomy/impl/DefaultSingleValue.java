...
public class DefaultSingleValue implements SingleValue, Introspectable {
  ...
  public void externalise(AbsObject absObj, Ontology onto) throws OntologyException {
    try {
      ...
      abs.set(TaxonomyOntology.SINGLEVALUE_MEASURINGUNIT, (AbsTerm) onto.fromObject(getMeasuringUnit()));
      abs.set(TaxonomyOntology.SINGLEVALUE_VALUE, value);
      abs.set(TaxonomyOntology.SINGLEVALUE_DESCRIBES, (AbsTerm) onto.fromObject(getDescribes()));
  ...
  public void internalise(AbsObject absObj, Ontology onto) throws UngroundedException, OntologyException {
    try {
      AbsConcept abs = (AbsConcept) absObj;
      measuringUnit = (String)onto.toObject(abs.getAbsObject(TaxonomyOntology.SINGLEVALUE_MEASURINGUNIT));
      value = abs.getFloat(TaxonomyOntology.SINGLEVALUE_VALUE);
      describes = (List)onto.toObject(abs.getAbsObject(TaxonomyOntology.SINGLEVALUE_DESCRIBES));
     } catch (ClassCastException cce) {
