...
public class DefaultIsDescriptiveElement implements IsDescriptiveElement, Introspectable {
  ...
  public void externalise(AbsObject absObj, Ontology onto) throws OntologyException {
    try {
      ...
      abs.set(CBRTerminologyOntology.ISDESCRIPTIVEELEMENT_DESCRIPTIVEELEMENT, (AbsTerm) onto.fromObject(getDescriptiveElement()));
  ...
  public void internalise(AbsObject absObj, Ontology onto) throws UngroundedException, OntologyException {
    try {
      AbsPredicate abs = (AbsPredicate) absObj;
      descriptiveElement = (Object)onto.toObject(abs.getAbsObject(CBRTerminologyOntology.ISDESCRIPTIVEELEMENT_DESCRIPTIVEELEMENT));
     } catch (ClassCastException cce) {
