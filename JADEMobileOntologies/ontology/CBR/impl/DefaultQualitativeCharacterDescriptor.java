...
public class DefaultQualitativeCharacterDescriptor implements QualitativeCharacterDescriptor, Introspectable {
  ...
  public void externalise(AbsObject absObj, Ontology onto) throws OntologyException {
    try {
      ...
      abs.set(CBRTerminologyOntology.QUALITATIVECHARACTERDESCRIPTOR_ATTRIBUTE, (AbsTerm) onto.fromObject(getAttribute()));
      abs.set(CBRTerminologyOntology.QUALITATIVECHARACTERDESCRIPTOR_STRUCTURE, (AbsTerm) onto.fromObject(getStructure()));
      abs.set(CBRTerminologyOntology.QUALITATIVECHARACTERDESCRIPTOR_SCORE, (AbsTerm) onto.fromObject(getScore()));
  ...
  public void internalise(AbsObject absObj, Ontology onto) throws UngroundedException, OntologyException {
    try {
      AbsConcept abs = (AbsConcept) absObj;
      attribute = (Attribute)onto.toObject(abs.getAbsObject(CBRTerminologyOntology.QUALITATIVECHARACTERDESCRIPTOR_ATTRIBUTE));
      structure = (Object)onto.toObject(abs.getAbsObject(CBRTerminologyOntology.QUALITATIVECHARACTERDESCRIPTOR_STRUCTURE));
      score = (List)onto.toObject(abs.getAbsObject(CBRTerminologyOntology.QUALITATIVECHARACTERDESCRIPTOR_SCORE));
     } catch (ClassCastException cce) {
